...
As an aside before I dive in, 

---
## My PhD research with NOAA SWFSC
...
I did a lot of my PhD research with colleagues at NOAA Southwest Center. I did field work with John Field, who's pictured here, where we put electronic pop-up tags on Humboldt squid off the coast of California. And it was Steven Bograd and Dave Foley were helped me learn how to code so I could make sense of all the data we got back. 

This was the start of my data and coding journey, where I learned how importanting coding and reproducibility was. and it's been over eight years since I finished my PhD and have been at NCEAS. So what I want to talk about today:
...
### Reframe data analysis as a collaborative effort. 
### Build for resilience, inclusion, teams, and community.
...
- **Amazed continually by the \#rstats community**
]
.footnote[
source: [*Lowndes et al. 2017* Our path  to better science in less time using open data science tools](https://www.nature.com/articles/s41559-017-0160)
]
...
.footnote[
art: [@allison_horst](https://twitter.com/allison_horst); [blog](https://www.openscapes.org/blog/2020/10/12/tidy-data/)
]
...
---
```{r tidy_collab, out.width = '90%', fig.align='center'}
knitr::include_graphics("img/horst_tidy_collab.png")
```
...
<br>
<br>
```{r tidy_datasets, out.width = '90%', fig.align='center'}
...
.footnote[
source: [*Lowndes et al. 2019*  Supercharge your research: a 10-week plan for open data science](https://www.nature.com/articles/d41586-019-03335-4)
]
