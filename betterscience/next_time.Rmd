...
[`r icon::fa("desktop")` openscapes.org/media](https://openscapes.org/media)  
...
transition: so for Luke, it is a combination of the Force and his community that make this him so powerful
...
And I think it's the same with open data science tools & practices and teamwork and collaboration. 

This is what better science in less time looks like to me. 
...
I've been working on how to pay this forward and help other groups
...
<br>
```{r data-science-r4dsu, out.width = '90%', fig.align='center'}
...
<br>
```{r tidyverser, out.width = '60%', fig.align='center'}
...
**Seaside Chats** • **Eco-Data-Science • RLadiesSB** 
]
...
Recreated this online with Openscapes
...
---
### Openscapes [Sea]side chats & meetups
...
```{r teamc, out.width = '70%', fig.align='center'}
knitr::include_graphics("img/ohi-team-2018b-crop.jpeg") 
```
...
**Leadership (vertical & horizontal): enabling & supportive**  
...
---
### Openscapes Champions: inaugural cohort 2019

```{r zoom-left, out.width = '50%', fig.align='center'}
...
```{r value-welcome, out.width = '50%', fig.align='center'}
knitr::include_graphics("img/ropensci-butland-welcome.png")
```

```{r hadley-could-be-betterx, out.width = '60%'}
knitr::include_graphics("img/tweet-allimoberger-hadley.png")
```

.footnote[
tweet: [@allimoberger](https://twitter.com/allimoberger/status/1085268564821585921)
blog: [ropensci.org](https://ropensci.org/blog/2017/07/18/value-of-welcome/)
]


???

and then when you combine those tweets with other ideas like the value of welcome 
...
Here together to save time and because I'm still trying to figure out how to talk about how important they have been on my life while also keeping my voice steady. 

They welcomed me and empowered me and believed in me before I really understood the importance 
...
---
class: middle
.whisper[This isn’t just about coding and GitHub, this is about changing how we do science]

**- Malin Pinsky, Professor at Rutgers University & Openscapes Champion**
.footnote[
...
---
class: center, middle
```{r careers-screenshot, out.width = '50%', fig.align='center'}
knitr::include_graphics("img/tweet-openscapes-supercharge.png") 
```
...
.footnote[
tweet: [@openscapes](https://twitter.com/openscapes/status/1189996719800373248); source: [*Lowndes et al. 2019*](https://www.nature.com/articles/d41586-019-03335-4)
]
...
###OHI team <br>Mozilla team<br>Openscapes labs<br>RLadies team
<br>
