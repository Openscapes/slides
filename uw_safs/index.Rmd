...
**What does it look like: Ocean Health Index**
### Open data science as a mindset
### Reimagine collaboration & communication 

# How to supercharge your research 

### Think as a team: Openscapes
### Talk about data
### Identify and address needs
### Think ahead for Future You and Future Us

???

Team: overlapping skillsets, roles, 

---
# 2 narratives: 
OHI and Openscapes. 
(2 slides as banners, like NCEAS directors' council
???
...
<!---### XXX expect a better way • Open data science as a mindset • reimagine science communication --->
transition: what does this look like: 

What it looks like, the tools involved, the communities involved, the mindset involved, the teamwork involved. 
...
.footnote[
[Andy Teucher](https://github.com/ateucher/vic-geogeeks-2018-01-30)
]
]
...
---
# Better science in less time 
```{r reprise, out.width = '100%', fig.align='center'}
