...
<!---
### The problem
We are struggling with data analysis as individuals

<br>

## This matters now
We study critical systems affected by climate change, and have no time to waste

## A solution
Engage with existing open data science tools and communities, as teams
...
### What does it look like (tools)
### Open data science as a mindset (team)
### How to supercharge your research (you)

.pull-right[

###  <img src="img/openscapes-hex.png" alt="" style="float:right;width:100px;"/> <img src="img/ohi-hex.png" alt="" style="float:right;width:100px;"/>
]
...
**Ocean Health Index background**  
**Tools and workflow**  
**Reimagine communication & publishing**  
<br>
<br>
<br>
<br>
...
First global assessment in 2012, big deal. after 4 years work to develop the models workflow, find and process and model data. 
...
But when we actually went to repeat it, it was a bummer. Because of our workflow.
...
---
## Reimagine communication and publishing
...
>> insert quote from paper "we couldn't reproduce our own work" -- it was the tidying as much as the modeling. 
...
---
# Data science is a discipline
### Tools to operationalize theory
...
And there is R code to do it. And if multiple people in a research group are thinking this way and working this way, togetther with GitHub, it's a way to streamline how you collaborate. 
...
---
class: center
```{r team-hands, out.width = '70%', fig.align='center'}
knitr::include_graphics("img/horst-starwars-hands.png") 
```

--

**trust** • **shared values** • **resilience** • **overlapping skillsets & interoperability** • **horizontal leadership**
...
**"This isn’t just about coding and GitHub, this is about changing how we do science"**   
— [Dr. Malin Pinsky, Marine Ecologist at Rutgers & Openscapes Champion](https://www.openscapes.org/blog/2019/04/08/summit-reflections1/)
...
```{r openscapesing, out.width = '60%', fig.align='center'}
knitr::include_graphics("img/openscapesing-6thfloor.jpg") 
```
...
???
 ...
 Mindset open to learning from anyone 
