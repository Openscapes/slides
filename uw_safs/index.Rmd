...
---
.pull-left[
```{r luke2, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/horst-starwars-luke.png")
```

### `data_final_v3.xls`
### `paper_with_figures_v3.doc`
...
.pull-right[
```{r yoda2, out.width = '95%', fig.align='center'}
knitr::include_graphics("img/horst-starwars-yoda.png")
```

### `data/species_by_site.csv`
### `R/species_model.Rmd`
### `Issue #20: Species modeling by site`
]
...
---
# screenshot Rmd Garrett

???

Also R code for publishing. And mixed with GH, lets you publish. 
...
```{r team, out.width = '70%', fig.align='center'}
knitr::include_graphics("img/ohi-team-2018b-crop.jpeg") 
```

**Horizontal leadership** •  **Trust** • **Overlapping skillsets** • **Seaside Chats**

Resilience. Skillsharing. Mindset open to learning from anyone 
...
---
# Open data science tools match theory
<br>
<br>

```{r tidyverse, out.width = '90%', fig.align='center'}
...
And there is R code to do it

---
## TODO: githubs tidyverse screenshot
<br>
<br>

```{r tidyverse-collab, out.width = '90%', fig.align='center'}
knitr::include_graphics("img/r4ds_data-science.png")
```
...
TODO: Add Steph Wright's def of Open. inclusion. 
...
---
# Twitter. Allison figure, also rnoaa example. 

And Hadley could always be better

???

More of reimagining communicatino. Not just the tools, the mindset
...
Follow selectively, listen & learn, e.g.:
...
---
```{r reprise-env, out.width = '100%'}
knitr::include_graphics("img/horst-eco-r4ds-env-only.png") 
```
